...
import { Upload, Palette, Type, Image, Calendar, Users, Gift, Award, Megaphone, Info } from 'lucide-react';
...
function App() {
  ...
  const [posterData, setPosterData] = useState<PosterData>({
    ...
    message: "We're excited to have you join us. Let's achieve great things together!"
  });
  ...
  const extractBrandIdentity = () => {
    ...
    setTimeout(() => {
      ...
      const mockBrandIdentity: BrandIdentity = {
        ...
        secondaryColors: ['#F59E0B', '#F97316', '#FBBF24'],
        fonts: ['Montserrat', 'Open Sans'],
        logoUrl: 'https://images.pexels.com/photos/3756766/pexels-photo-3756766.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'
      };
  ...
  const handlePosterTypeChange = (type: PosterType) => {
    ...
    switch(type) {
      case 'onboarding':
        ...
        newMessage = "We're excited to have you join us. Let's achieve great things together!";
        break;
      case 'birthday':
        newTitle = 'Happy Birthday!';
        newMessage = 'Wishing you a fantastic day filled with joy and celebration!';
        break;
      case 'anniversary':
        newTitle = 'Work Anniversary';
        newMessage = 'Congratulations on another year of excellence and dedication!';
        break;
      case 'announcement':
  ...
  const handlePosterDataChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-gray-900">Brand Identity Analyzer</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {step === 1 && (
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-semibold mb-4">Upload Brand Collateral</h2>
            <p className="text-gray-600 mb-6">
              Upload a branding collateral file (PDF, image, or presentation) to extract brand identity elements.
            </p>
        ...
        {step === 2 && brandIdentity && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-semibold mb-4">Extracted Brand Identity</h2>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="mt-1 text-lg font-semibold">{brandIdentity.brandName}</p>
                </div>
                  ...
                  <div className="mt-2 space-y-2">
                    {brandIdentity.fonts.map((font, index) => (
                      <div key={index} className="flex items-center">
                        ...
                        {index === 1 && (
                          <span className="ml-2 text-xs bg-gray-100 text-gray-800 px-2 py-0.5 rounded">Secondary</span>
                        )}
                      </div>
                    ))}
                  </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-semibold mb-4">Configure Your Poster</h2>
              
              <div className="space-y-6">
                {/* Poster Type Selection */}
                <div>
                  <h3 className="text-sm font-medium text-gray-500">Poster Type</h3>
                ...
                {/* Poster Content */}
                <div>
                  <h3 className="text-sm font-medium text-gray-500">Poster Content</h3>
        ...
        {step === 3 && brandIdentity && posterGenerated && (
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-semibold mb-4">Your Generated Poster</h2>
            
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Poster Preview */}
              <div>
                <h3 className="text-sm font-medium text-gray-500 mb-3">Poster Preview</h3>
                ...
                <div className="border border-gray-200 rounded-lg overflow-hidden shadow-lg">
                  ...
                  >
                    {/* Logo */}
                    {brandIdentity.logoUrl && (
                      <div className="absolute top-6 left-6 h-16 w-16 rounded-full bg-white p-2 shadow-md">
                        <img 
                          src={brandIdentity.logoUrl} 
                          alt="Brand Logo" 
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-sm font-medium text-gray-500 mb-2">Design Rationale</h3>
                  <div className="bg-gray-50 rounded-md p-4 text-sm text-gray-700">
                    <p className="mb-3">
                      This poster design leverages the brand identity elements extracted from your collateral:
                    </p>
                    <ul className="list-disc pl-5 space-y-2">
                      <li>
                        <strong>Color Palette:</strong> The primary brand colors create a gradient background that establishes brand recognition, while the secondary colors are used as accent elements.
                      </li>
                      <li>
                        <strong>Typography:</strong> The font hierarchy maintains the brand's typographic style, with the primary font used for headings and the secondary font for body text.
                      </li>
                      <li>
                        <strong>Logo Placement:</strong> The logo is positioned prominently but not overwhelmingly, maintaining brand presence while allowing the message to take center stage.
                      </li>
                      <li>
                        <strong>Layout:</strong> The clean, centered layout with ample white space creates a professional and modern aesthetic that aligns with contemporary design principles.
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-500 mb-2">Download Options</h3>
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-500 mb-2">Editable Source</h3>
                  <div className="border border-gray-300 rounded-md p-4 bg-gray-50">
                    <p className="text-sm text-gray-600 mb-3">
                      Access the editable version of this poster through one of these platforms:
                    </p>
